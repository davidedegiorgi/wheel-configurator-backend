...
(1, 1, 'Mozzo DT Swiss 350', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss350.jpg', 700.00, NOW(), NOW()),
(2, 1, 'Mozzo DT Swiss 240', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss240.jpg', 700.00, NOW(), NOW()),
...
(12, 2, 'Mozzo DT Swiss 350', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss350.jpg', 700.00, NOW(), NOW()),
(13, 2, 'Mozzo DT Swiss 240', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss240.jpg', 700.00, NOW(), NOW()),
...
(23, 3, 'Mozzo DT Swiss 350', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss350.jpg', 700.00, NOW(), NOW()),
(24, 3, 'Mozzo DT Swiss 240', 'mozzo', 0, '/wheel-configurator/components/mozzo-dtswiss240.jpg', 700.00, NOW(), NOW()),
...
SELECT setval(pg_get_serial_sequence('wheel_hubs', 'id'), (SELECT MAX(id) FROM wheel_hubs));
SELECT setval(pg_get_serial_sequence('wheel_components', 'id'), (SELECT MAX(id) FROM wheel_components));
